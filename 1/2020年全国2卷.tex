...
%思想方法:对称
%题目特征:
%题目备注:其中$ a $与$ b $两点的场强与$ cd $相似利用对称即可。
...
%思想方法:整体
%题目特征:
%题目备注:解题时需要注意其中两个条件：一是反弹物块不能追上运动员，二是共重复$ 8 $次。分别给出质量的上下范围。
...
\begin{center}
 \includesvg[width=0.53\linewidth]{picture/svg/GZ-3-tiyou-0629} 
\end{center}
...
%思想方法:参考系变换
%题目特征:计算练习
%题目备注:按照一般解法，计算量较大，可变换参考系，利用相对位移求解。
...
%思想方法:小量近似
%题目特征:材料分析
%题目备注:正常解方程会遇到一个一元二次方程，很难解，将$ l $看作一个小量，将其中$ l^{2} $略去，可解。
